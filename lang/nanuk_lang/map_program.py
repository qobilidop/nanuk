...
``nanuk_ir.lower_map.to_map_asm(build_ir())``. Tables are declared on the
...
from nanuk_ir.validate_map import IR_VERSION
...
class MapProgram:
    ...
    def compile(self) -> str:
        """build_ir() + nanuk_ir MAP lowering; returns assembled program text."""
