...
| IR schema (buf lint + breaking vs main; regen gencode: `scripts/gen.py` from sw/python) | `./dev.sh bash -lc 'buf lint spec/proto && buf breaking spec/proto --against ".git#branch=main,subdir=spec/proto"'` |
