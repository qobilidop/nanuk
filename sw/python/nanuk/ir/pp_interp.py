...
Semantics mirror ISA totality (spec/sail/model/pp, frozen in the stage-1 plan):
...
# Mirror of spec/sail/model/pp/params.sail (see also nanuk.testkit.pp_harness).
BUF_BYTES = 256
NHDR = 16
SMD_SLOTS = 8
STEP_BUDGET = 256
...
class _Machine:
    ...
    def tick(self) -> None:
        # Mirrors step() in spec/sail/model/pp/exec.sail: budget checked before the
