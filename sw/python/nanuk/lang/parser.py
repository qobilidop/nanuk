...
returns a ParserState object usable as a dispatch/goto target (including forward
...
class Parser:
    ...
    def build_ir(self) -> ir.ParserProgram:
        """Run every state body and return the nanuk.ir.v0 ParserProgram."""
        ...
        program = ir.ParserProgram(ir_version=IR_VERSION)
        for st in ordered:
