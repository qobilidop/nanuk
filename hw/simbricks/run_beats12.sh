...
./dev.sh bash -lc '
    ...
    uv run nanuk-asm nanuk/examples/l2l3l4/parse.asm -o ../hw/simbricks/out/prog.bin &&
    uv run nanuk-map-asm nanuk/examples/map_l2fwd/fwd.asm -o ../hw/simbricks/out/map.bin
'
